...
Requires: nbdime-bin = %{version}-%{release}
Requires: nbdime-data = %{version}-%{release}
Requires: nbdime-license = %{version}-%{release}
Requires: nbdime-python = %{version}-%{release}
Requires: nbdime-python3 = %{version}-%{release}
...
%package bin
Summary: bin components for the nbdime package.
Group: Binaries
Requires: nbdime-data = %{version}-%{release}
Requires: nbdime-license = %{version}-%{release}

%description bin
bin components for the nbdime package.


%package data
Summary: data components for the nbdime package.
Group: Data

%description data
data components for the nbdime package.


%package license
Summary: license components for the nbdime package.
Group: Default

%description license
license components for the nbdime package.


%package python
Summary: python components for the nbdime package.
Group: Default
Requires: nbdime-python3 = %{version}-%{release}

%description python
python components for the nbdime package.


%package python3
Summary: python3 components for the nbdime package.
Group: Default
...
%description python3
python3 components for the nbdime package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637344501
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/nbdime
cp %{_builddir}/nbdime-3.1.1/LICENSE.md %{buildroot}/usr/share/package-licenses/nbdime/ff097755ecfcda288aeecae6768698bd7403f179
...
/usr/share/package-licenses/nbdime/ff097755ecfcda288aeecae6768698bd7403f179
